...
>
> Pro MASTER pravidla platí pouze `00_CHATGPT_START/MASTER_PACK_V2/MASTER_REFERENCE.md`.
> Tento guide je vstupní kontext projektu, ne samostatný MASTER systém. Starší zmínky o Glute Bridge HERO jako jediném MODEL MASTER jsou zastaralé; platí rozdělený MASTER CHARACTER, MASTER ENVIRONMENT, MASTER STYLE a EXERCISE_REFERENCE podle MASTER_PACK_V2.
...
- MASTER_PACK_V2 / Glute Bridge HERO jako kvalitativní reference

Glute Bridge HERO není inspirace. Je závazná předloha.
...
"Kdyby někdo viděl Glute Bridge HERO a nový obrázek vedle sebe, uvěřil by, že byly nafoceny během jednoho dopoledne jedním fotografem?"
...
- MASTER_PACK_V2 je jediný MASTER systém pro obrázky; Glute Bridge HERO zůstává schválená reference kvality.
...
Pro MASTER pravidla má přednost MASTER_PACK_V2. Tento dokument slouží jako projektový vstupní kontext.
