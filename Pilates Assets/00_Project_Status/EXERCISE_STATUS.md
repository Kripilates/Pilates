...
- Schválená `glutes_lateral_glutes_primary_core_secondary_muscles_v01.png` je nasazena výhradně pro `abduction` a `rainbow` (PRIMARY A11 + A12; SECONDARY A01).
...
- SOURCE do nového prostředí: žádný.
