...
| Roll Up | `Pilates Assets/02_Exercise_Cards/Roll Up` | `roll_up_start.png` | `roll_up_hero.png` + END `roll_up_end.png` | `roll_up_guide_card_v01.png` | `roll_up_step_by_step_v01.png` | ANO | COMPLETE | Finální bezverzové SOURCE; START → HERO → END; App `rollup` |
