...
| Standing Side Bend | `Pilates Assets/02_Exercise_Cards/Standing Side Bend` | `standing_side_bend_start_v02.png` | `standing_side_bend_hero_v02.png` + `standing_side_bend_hero_opposite_v02.png` | `standing_side_bend_guide_card_v01.png` | `standing_side_bend_step_by_step_v01.png` | NE | COMPLETE | HERO opposite = `standing_side_bend_hero_opposite_v02.png`; END = START v02 reuse; App beze zmeny v tomto ukolu |
...
| Toe Tap | `Pilates Assets/02_Exercise_Cards/Toe Tap` | `toe_tap_start_v01_approved.png` | `toe_tap_hero_v01_approved.png` | `toe_tap_guide_card_v1.png` | `toe_tap_step_by_step_v1.png` | ANO | COMPLETE | END = START; approved hashes verified; Guide/Step rebuilt; App deployed as `toetap` |
