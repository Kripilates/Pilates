...
START = BASE / "donkey_kick_start_v01.png"
HERO = BASE / "donkey_kick_hero_v01.png"
GUIDE = BASE / "donkey_kick_guide_card_v01.png"
STEP = BASE / "donkey_kick_step_by_step_v01.png"

EXPECTED = {
    START: "c43ab034dbb402b4e7442a7e761e0f494d37dd610eef7fd18af36ce75663bfd0",
    HERO: "831312de33ab9b890ba544eab8b45e3c47b88adce6927dfc335810c04ce2153d",
}
...
GUIDE_HOW = [
    ("1", "Začni na všech čtyřech. Dlaně dej pod ramena, kolena pod kyčle a záda drž neutrálně."),
    ("2", "S výdechem zvedni jednu pokrčenou nohu dozadu a nahoru. Koleno drž přibližně v úhlu 90° a pánev vodorovně."),
    ("3", "S nádechem vrať koleno kontrolovaně pod kyčel. Opakuj podle programu a potom vystřídej strany."),
]

GUIDE_WATCH = (
    "Neprohýbej bedra, nevytáčej pánev a nezvedej nohu výš za cenu "
    "ztráty neutrální polohy zad."
)
...
STEP_TEXTS = [
    (
        ...
        "START",
        START,
        "Začni na všech čtyřech. Dlaně dej pod ramena, kolena pod kyčle a záda drž neutrálně.",
    ),
    (
        "KROK 2",
        "ZANOŽENÍ",
        HERO,
        "S výdechem zvedni jednu pokrčenou nohu dozadu a nahoru. Koleno drž přibližně v úhlu 90° a pánev vodorovně.",
    ),
    (
        "KROK 3",
        "NÁVRAT",
        START,
        "S nádechem vrať koleno kontrolovaně pod kyčel. Opakuj podle programu a potom vystřídej strany.",
    ),
]

STEP_BREATH = "Výdech při zvednutí nohy. Nádech při návratu."
STEP_WATCH = (
    "Neprohýbej bedra, nevytáčej pánev a nezvedej nohu výš za cenu "
    "ztráty neutrální polohy zad."
)
...
def build_guide():
    ...
    draw.text((62, 52), "ZANOŽOVÁNÍ V KLEKU", font=F["title"], fill=INK)
    draw.text((62, 98), "Donkey Kick", font=F["small_b"], fill=TEAL_D)
    draw_wrapped(
        draw,
        (62, 118),
    ...
    x = pill(draw, (62, 142), "Hýždě", F["small_b"])
    pill(draw, (x, 142), "Stabilita pánve", F["small_b"])
    ...
    labels = [
        ("START", "Na všech čtyřech"),
        ("ZANOŽENÍ", "Pokrčená noha vzhůru"),
        ("NÁVRAT", "Koleno pod kyčel"),
    ]
    ...
    info = [
        ...
        ("focus", "ZAMĚŘ SE", "Pánev stabilní, břicho aktivní, ramena volná."),
        ("repeat", "OPAKOVÁNÍ", "Podle dávky v tréninku. Potom vystřídej strany."),
    ]
...
def build_step():
    ...
    draw.text((62, 98), "ZANOŽOVÁNÍ V KLEKU / Donkey Kick", font=F["small_b"], fill=TEAL_D)
