...
START = BASE / "inner_thigh_lift_start_v01.png"
HERO = BASE / "inner_thigh_lift_hero_v01.png"
GUIDE = BASE / "inner_thigh_lift_guide_card_v01.png"
STEP = BASE / "inner_thigh_lift_step_by_step_v01.png"
EXPECTED_HASHES = {
    START: "8ac288229c2ba3a526d202d4ac5124ee355443c7fbc3cf57552d6e054fc52f7d",
    HERO: "426b508039138fed7720914ea1660ac5025fd2c77592488cea42b39e5ba6d89c",
}
...
GUIDE_HOW = [
    ("1", "Lehni si na bok. Spodní nohu nech nataženou, horní pokrč a chodidlo polož před spodní koleno."),
    ("2", "Zpevni střed těla a pomalu zvedni spodní nataženou nohu několik centimetrů nad podložku."),
    ("3", "Pánev drž stabilní a potom nohu pomalu spusť zpět. Pokračuj plynule bez švihu."),
]

GUIDE_WATCH = (
    "Neotáčej pánev dozadu, nešvihej nohou a nezvedej ji příliš vysoko. "
    "Pohyb veď pomalu a kontrolovaně."
)
...
STEP_TEXTS = [
    (
        "KROK 1",
        "VÝCHOZÍ POZICE",
        "Lehni si na bok. Spodní nohu nech nataženou, horní pokrč a chodidlo polož před spodní koleno. Hlava je pohodlně opřená o paži.",
        START,
    ),
    (
        "KROK 2",
        "ZVEDNUTÍ SPODNÍ NOHY",
        "Zpevni střed těla a pomalu zvedni spodní nataženou nohu několik centimetrů nad podložku. Pánev zůstává stabilní.",
        HERO,
    ),
    (
        "KROK 3",
        "KONTROLOVANÝ NÁVRAT",
        "Pomalu spusť nohu zpět na podložku a opakuj plynulým kontrolovaným pohybem.",
        START,
    ),
]

STEP_BREATH = "Výdech při zvednutí spodní nohy. Nádech při kontrolovaném návratu."
STEP_WATCH = (
    "Pánev drž stabilní, neotáčej se dozadu a nešvihej nohou. "
    "Zvedej ji jen několik centimetrů nad podložku."
)
