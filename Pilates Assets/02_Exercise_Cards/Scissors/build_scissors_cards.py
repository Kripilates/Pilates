...
GUIDE_HOW = [
    ("1", "Lehni si na záda, paže polož podél těla a dlaně opři o podložku."),
    ("2", "Zpevni břicho a zvedni natažené nohy do rozdílné výšky. Pánev drž klidnou."),
    ("3", "Plynule vystřídej nohy – horní spouštěj dolů a spodní současně zvedej vzhůru. Pánev drž stabilní."),
]

GUIDE_WATCH = (
    "Hlavu a ramena nech na podložce. Bedra měj pod kontrolou, kolena nepokrčuj "
    "a pohyb neprováděj švihem."
)
...
STEP_TEXTS = [
    (
        "KROK 1",
        "VÝCHOZÍ POLOHA",
        "Lehni si na záda, nohy natáhni a paže polož podél těla. Dlaně opři o podložku, pánev drž neutrálně a bedra pod kontrolou.",
        START,
    ),
    (
        "KROK 2",
        "NŮŽKOVÁ POLOHA",
        "Zpevni střed těla. Jednu nataženou nohu zvedni výš a druhou drž níže nad podložkou. Hlavu, ramena i pánev nech klidné.",
        HERO,
    ),
    (
        "KROK 3",
...
STEP_BREATH = "Dýchej plynule. Při vystřídání nohou vydechuj."
STEP_WATCH = (
    "Pánev nezvedej ani nenakláněj. Kolena drž natažená, ale nepřepínej je. "
    "Pokud se bedra odlepují, zmenši rozsah pohybu."
)
...
def build_guide():
    ...
    draw.text((62, 49), "NŮŽKY", font=F["title"], fill=INK)
    draw.text((62, 94), "Spodní břicho a stehna", font=F["small_b"], fill=TEAL_D)
    _, desc_bottom = draw_wrapped(
        draw, (62, 115), "Střídej natažené nohy a pánev drž stabilní na podložce.",
        F["tiny"], MUTED, 650, 2
    )
    ...
    info = [
        ("breath", "DECH", "Dýchej plynule. Vydechuj při vystřídání."),
        ("focus", "ZAMĚŘ SE", "Stabilní pánev a kontrolovaná bedra."),
        ("repeat", "OPAKOVÁNÍ", "24× střídavě"),
    ]
...
def build_step():
    ...
    draw.text((62, 98), "NŮŽKY", font=F["small_b"], fill=TEAL_D)
