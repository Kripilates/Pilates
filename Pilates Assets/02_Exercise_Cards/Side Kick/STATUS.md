...
START → KOP DOPŘEDU → KOP DOZADU

## Guide Card

- [x] Created — `side_kick_guide_card_v01.png`
- [x] QA — SCHVÁLENO

## Step by Step

- [x] Created — `side_kick_step_by_step_v01.png`
- [x] QA — SCHVÁLENO
...
- Použity pouze schválené source obrázky START, HERO a END.
