...
- aktivní ID: 51
- nové prostředí: 49
- rozpracováno / mapping k ověření: 1 (`sideplank_reach` — unversioned SOURCE
  fyzicky existují, runtime stále používá staré `*_v01.png`)
- staré prostředí: 1 (`swimming`)
...
- `frog` má podle autoritativního auditu profil A11 + A01; jeho současné runtime mapování na A11 + A14/A01 je evidovaný mapping mismatch k samostatné opravě
