...
> **HISTORICAL DECISION LOG.** Nejde o aktuální MASTER specifikaci ani inventuru.
> Aktuální pravidla jsou v `00_CHATGPT_START/MASTER/01_DOCUMENTS/`.
...
|---|---|---|---|---|
| Bird Dog | HERO | HAIR_MAJOR_DIFFERENCE + MUSCULARITY_MINOR_DIFFERENCE | HAIR_LOCAL_FIX_APPLIED_V1 | Hair local fix V1 was approved and applied to source. Body is not a regeneration reason. |
...
Bird Dog HERO source was updated with approved Hair Fix V1. Bird Dog START remains HAIR_LOCAL_FIX_CANDIDATE. Fire Hydrant remains REGENERATE_SOURCE_MODEL_MISMATCH.
