...
| Glute Bridge | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | START je přesný reuse Hollow Hold START v05 `0264a431…`; HERO v03 `_approved` `aeaaa7d2…`; END = START; fotografie v Guide v3 a Step v2 aktualizovány bez změny textů/layoutu; svalová karta `glute_bridge_muscles_v01.png`; app mapování pod ID `hip` aktualizováno |
