...
| Dead Bug | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 🟡 | HOTOVO | START/HERO v01 `_approved` ověřeny přesnými SHA-256; END = START; Guide/Step v01 přegenerované a vizuálně ověřené; nový balíček zatím není propojen do aplikace |
...
| Glute Bridge | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 🟡 | HOTOVO | Referenční cvik; START/HERO v02 `_approved` s hashi `80c3…` / `961e…`; END = START; Guide v3 a Step v2 reprodukovány a ověřeny; aplikace v tomto assetovém úkolu beze změny |
| Glute Bridge March | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 🟡 | HOTOVO | START reuse Glute Bridge START `80c3…`; MID reuse Glute Bridge HERO `961e…`; HERO v01 `_approved` `6014…`; START → MID → HERO → MID → START; Guide/Step v02 přegenerované; zatím nepropojeno do aplikace |
...
| Heel Taps | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 🟡 | HOTOVO | START/HERO v03 `_approved` ověřeny přesnými SHA-256; END = START; Guide/Step v01 přegenerované a vizuálně ověřené; v03 zatím nepropojeno do aplikace |
| Hip March | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 🟡 | HOTOVO | START v03 `_approved` reuse Glute Bridge START `80c3…`; HERO v03 `_approved` `7ed5…`; END = START; Guide/Step v01 reprodukované a ověřené; zatím nepropojeno do aplikace |
...
| Standing Side Bend | ⛔ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | START a obě HERO strany v02 schválené; sekvence START → úklon do strany → úklon na opačnou stranu; Guide Card a Step by Step v01 přegenerované ze SOURCE v02; App beze změny v tomto úkolu; čistý boční úklon bez rotace a bez přitahování lokte ke koleni |
...
| Thread the Needle | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | START/HERO v02 schválené; END = START v02 bez samostatného PNG; Guide Card a Step by Step v01 přegenerované z v02 source; App nasazena pod kanonickým ID `thread`; programové dávky beze změny |
| Toe Tap | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 🟡 | HOTOVO | START/HERO v01 `_approved` ověřeny přesnými SHA-256; END = START; Guide/Step v1 přegenerované a vizuálně ověřené; zatím nepropojeno do aplikace |
