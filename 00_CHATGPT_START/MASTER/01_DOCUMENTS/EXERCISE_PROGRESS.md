...
| Glute Bridge | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | Referenční cvik; START/HERO v02 `_approved` s hashi `80c3…` / `961e…`; END = START; Guide v3 a Step v2 reprodukovány, ověřeny a nasazeny v aplikaci pod ID `hip` |
| Glute Bridge March | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | START reuse Glute Bridge START `80c3…`; MID reuse Glute Bridge HERO `961e…`; HERO v01 `_approved` `6014…`; START → MID → HERO → MID → START; Guide/Step v02 přegenerované a nasazené pod ID `glute_bridge_march` |
...
| Heel Taps | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | START/HERO v03 `_approved` ověřeny přesnými SHA-256; END = START; Guide/Step v01 přegenerované, vizuálně ověřené a nasazené pod ID `heeltaps` |
| Hip March | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | START v03 `_approved` reuse Glute Bridge START `80c3…`; HERO v03 `_approved` `7ed5…`; END = START; Guide/Step v01 reprodukované, ověřené a nasazené pod ID `hip_march` |
...
| Toe Tap | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | START/HERO v01 `_approved` ověřeny přesnými SHA-256; END = START; Guide/Step v1 přegenerované, vizuálně ověřené a nasazené pod ID `toetap` |
