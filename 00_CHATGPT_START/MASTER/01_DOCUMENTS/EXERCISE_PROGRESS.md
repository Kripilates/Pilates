...
| Glute Bridge | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | Finální SOURCE bez verzovacího čísla: `glute_bridge_start.png` `d3df1aee…` + `glute_bridge_hero.png` `055f549c…`; END = START; Guide v3 a Step v2 aktualizovány bez změny textů/layoutu; svalová karta `_Muscle_Cards/glutes_muscles_v01.png`; app mapování pod ID `hip` aktualizováno |
