...
| Roll Up | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | HOTOVO | Finální bezverzové `roll_up_start.png`, `roll_up_hero.png`, `roll_up_end.png`; sekvence START → HERO → END; Guide/Step v01 zachovány; App `rollup`; staré SOURCE ani placeholder nejsou aktivní |
